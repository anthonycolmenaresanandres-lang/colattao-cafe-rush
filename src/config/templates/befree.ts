...
export const befreeConfig: SiteConfig = {
  ...
  // Sovereign palette: a midnight-navy field (the "blue"), bone-white type
  // (the "white"), valor red accents (the "red"), and gold for the foil shine
  // and primary actions. Black-and-gold soul kept; stoic, ceremonial gravitas.
  palette: {
    ink: "#080B18", // near-black navy — hero overlay, deepest panels
    surface: "#0C1226", // midnight navy — page field (the visible blue)
    parchment: "#F2ECDE", // bone white — body type
    primary: "#D8B24F", // gold — solid CTAs (dark-navy text rides on it cleanly)
    secondary: "#C8463C", // valor red — eyebrows, tags, links
    accent: "#E7C463", // foil gold — hairlines, section headers, the shine
  },

  typography: {
    // Cinzel = engraved Roman capitals: stoic, sovereign, monumental.
    heading: 'var(--font-cinzel), "Trajan Pro", "Times New Roman", serif',
    body: "var(--font-inter), Inter, ui-sans-serif, system-ui, -apple-system, sans-serif",
  },
