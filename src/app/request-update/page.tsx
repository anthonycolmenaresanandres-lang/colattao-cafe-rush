...
export const metadata = {
  ...
  description:
    "Formulario de solicitudes para Colattao Coffee House — pida cambios de menú, precios, fotos, stickers, sitio web, juego o promociones.",
};
    ...
    <main className="mx-auto flex min-h-dvh w-full max-w-[560px] flex-col bg-colattao-page text-[var(--col-parchment)]">
      ...
      <header className="px-6 pb-4 pt-7 text-center">
        ...
        <p className="mx-auto mt-3 max-w-md text-[13px] leading-snug text-amber-100/85">
          Cuéntenos qué desea actualizar — menú, precios, fotos, stickers, sitio web, juego o
          promociones. Es rápido y no requiere cuenta.
        </p>
      ...
      <div className="px-4">
        <p className="rounded-xl border border-[#f5c46b]/30 bg-[#2a1208]/60 px-4 py-3 text-center text-[12px] font-semibold text-amber-100">
          Demo mode: this form does not send or save information yet.
          <span className="mt-1 block text-[11px] font-normal italic text-amber-200/70">
            Modo demostración: este formulario aún no envía ni guarda información.
          </span>
        </p>
      </div>
